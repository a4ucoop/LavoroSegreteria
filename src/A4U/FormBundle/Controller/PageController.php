    ...
    public function reportPAEAction()
    {
       ...
       foreach ($Users as $iscrittoForms) {
           ...
           if ($pos!==False) {
                ...
                $dati_iscritto->activity=($iscrittoForms->getActivity());
...
// ---------------------------------------STAGE--------------------------------------------
    ...
    #    return $this->render('A4UFormBundle:Forms:reportStage.html.twig', array(
    #        'both_subscribed' => $both_subscribed,
    #        'form_subscribed' => $form_subscribed));
    #}
...
// ---------------------------------------OpenDay--------------------------------------------
    ...
    public function openday_editAction($id, Request $request) {

        $em = $this->getDoctrine()->getManager();
        $stages = $em->getRepository('A4UFormBundle:OpenDay')->find($id);
        if (!$stages) {
          throw $this->createNotFoundException(
        ...
        $form = $this->createForm('openday', $stages);
        ...
        // Form non ancora inviato
        return $this->render('A4UFormBundle:Forms:openday_edit.html.twig', array(
            'form' => $form->createView(),
            'context' => $context,
        ));
    }
    ...
    public function reportOpenDayAction()
    {
       ...
       //ricavo il vettore degli iscritti a PAI che si sono immatricolati (array di oggetti!)
       $subscribed = $this->matchEsse3Action('A4UFormBundle:Openday');
       ...
       foreach ($Users as $iscrittoForms) {
        ...
        return $this->render('A4UFormBundle:Forms:reportOpenDay.html.twig', array(
            'both_subscribed' => $both_subscribed,
            'form_subscribed' => $form_subscribed));
    }
...
// ---------------------------------------GENERICO--------------------------------------------
    ...
    public function generico_editAction($id, Request $request) {
        ...
        $em = $this->getDoctrine()->getManager();
        $stages = $em->getRepository('A4UFormBundle:Generico')->find($id);
        if (!$stages) {
          throw $this->createNotFoundException(
                  'No generico found for id ' . $id
          );
        ...
        $form = $this->createForm('generico', $stages);
    ...
    public function reportGenericoAction()
    {
       ...
       foreach ($Users as $iscrittoForms) {
        ...
        return $this->render('A4UFormBundle:Forms:reportGenerico.html.twig', array(
            'both_subscribed' => $both_subscribed,
            'form_subscribed' => $form_subscribed));
    }
